...
import { addEmployee } from '../../Config/FirebaseServices'
...
function Form() {
  ...
  return (
<>
<div className="flex justify-center items-center w-screen h-screen bg-white mt-36">
...
<form onSubmit={handleSubmit(onSubmit)}>
		<div className="w-full p-8 my-4 md:px-12 lg:w-9/12 lg:pl-20 lg:pr-40 mr-auto rounded-2xl shadow-2xl">
            ...
            type="text" placeholder="Full Name" {...register("Username", { required: true })} />
				<input className="w-full bg-gray-100 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline"
            type="text" placeholder="Position" {...register("Position", { required: true })} />
				<input className="w-full bg-gray-100 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline"
            ...
            type="number" placeholder="Phone*" />
                       ...
                       <div className="col-span-2 sm:col-span-1 mt-6">
                        ...
                        <select id="category" {...register("Reporting", { required: true })} className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
